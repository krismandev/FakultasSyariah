...
<div class="panel">
  <div class="panel-heading">
    <h3 class="panel-title">Halaman Sejarah</h3>
  </div>
	@if($sejarah == null)
    ...
    <div class="panel-body">
      <div class="row mt-3" style="margin-top: 20px;">
        <div class="row">
            <div class="col-md-12">
                <textarea class="form-control" placeholder="textarea" rows="4" name="sejarah" id="sejarah"></textarea>
            </div>
        </div>
      </div>
      <div class="row">
  ...
  <form class="" action="{{route('storeVisiMisi')}}" method="post">
    ...
    <div class="panel-body">
        <div class="row mt-3" style="margin-top: 20px;">
          <div class="row">
              <div class="col-md-12">
                  <textarea class="form-control" placeholder="textarea" rows="4" name="sejarah" id="sejarah">{{$sejarah->sejarah}}</textarea>
              </div>
          </div>
        </div>
        <div class="row">
