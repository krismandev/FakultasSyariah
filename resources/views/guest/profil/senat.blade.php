        ...
        <div class="row">
            <div class="col-md-12">
                <div class="breadcrumbs">
                    ...
                    <span class="last-item">Senat Fakultas</span>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="section-title-area text-center">
                                <h2 class="section-title default-text-gradient">Senat Fakultas</h2>
                                {{-- <p class="section-description">Best offers from the house chef</p> --}}
                            </div><!-- /.section-title-area -->
                        </div><!-- /.col-md-12 -->
                    </div><!-- /.row -->
                    @if ($senat->gambar != null)
                    <div class="row">
                        <div class="col-md-12">
                            <div class="text-center">
                                <img src="{{url('img/senat/'.$senat->gambar)}}"/>
                            </div>
                        </div><!-- /.col-md-7 -->
                    </div><!-- /.row -->
                    @endif
