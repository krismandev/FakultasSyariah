...
<body>
	...
	<div id="wrapper">
		<!-- NAVBAR -->
		@include('layouts/dashboard/includes/_navbar')
		<!-- END NAVBAR -->
		<!-- LEFT SIDEBAR -->
	...
	<!-- END WRAPPER -->
	<!-- Javascript -->
	<script src="{{asset('assets-admin/assets/vendor/jquery/jquery.min.js')}}"></script>{{asset('assets-admin/')}}
	<script src="{{asset('assets-admin/assets/vendor/bootstrap/js/bootstrap.min.js')}}"></script>
	<script src="{{asset('assets-admin/assets/vendor/jquery-slimscroll/jquery.slimscroll.min.js')}}"></script>
