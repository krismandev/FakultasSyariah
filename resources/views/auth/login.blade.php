		...
		<div class="vertical-align-wrap">
			<div class="vertical-align-middle">
				@if(session('error'))
				    ...
				    <script>
				    	alert("Pastikan password dan email benar");
				    </script>
				@endif
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="{{asset('assets-admin/assets/img/logo-uin.jpg')}}" alt="Klorofil Logo" style="height: 150px; width: 150px;"></div>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Fakultas Syariah</h1>
